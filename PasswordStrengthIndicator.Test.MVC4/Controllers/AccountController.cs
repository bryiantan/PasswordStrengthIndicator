...
using PasswordStrengthIndicator.Test.MVC4.Filters;
using PasswordStrengthIndicator.Test.MVC4.Models;

namespace PasswordStrengthIndicator.Test.MVC4.Controllers
{
    [Authorize]
